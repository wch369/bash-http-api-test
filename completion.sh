...
_api_test_commands() {
    ...
    local commands="init make-request dry-run show-vars create-env create-template list-envs list-templates version help"
    local template_cmds="make-request dry-run show-vars"
